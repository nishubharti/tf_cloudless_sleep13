...
module "tf_module_test" {
 ...
 // source = "https://cm.globalcatalog.cloud.ibm.com/api/v1-beta/offering/source?archive=tgz&catalogID=6bcd5f68-4671-4461-bb3e-a75aeb10da3f&name=GoldenEye-acl-profile-ocp&version=^1.0.13"
